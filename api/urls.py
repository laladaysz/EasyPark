...
from . import views
from .views import delete_status, get_owner, receive_status, get_status, receive_plate, get_plate, receive_owner,delete_plate
...
urlpatterns = [
    ...
    path('delete-plate/', delete_plate, name='delete_plate'),
